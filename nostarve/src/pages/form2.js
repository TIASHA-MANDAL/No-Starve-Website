...
export default function Form2(props) {
    ...
    const submitData = async (event) => {
        ...
        if (Name && PhoneNumber && location  && Time1) {
            const res = fetch("https://service-e43c3-default-rtdb.firebaseio.com/Daily.json", {
                method: "POST",
                headers: {
        ...
        <div className="ssu">    <Navvv /></div>
            ...
            <div className="iiiv44">
                ...
                <section className=" sec12" >
                    <div className="register1222">
                        <div className="col-1110">
                            <div className="e">
                                <h2 className="ccc1">PROVIDE FOOD DAILY</h2>
                                <span className="vvv1">Fill up the form to get the service</span>
                            </div>
                            <form
                                id="form"
                            ...
                            >
                                ...
                                <Form.Label className="ccc1"></Form.Label>
