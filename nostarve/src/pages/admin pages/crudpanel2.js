...
export class CrudPanel2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            mode: '',
    ...
    handle() {
        ...
        //     console.log(Response);
        // }))
        axios.post('https://sheet.best/api/sheets/9036c3de-c58b-41d0-a05e-d726cb0b97e2', this.state.record).then((Response => {
            console.log(Response);
        }))
    }
    // openModal(option) {
                ...
                <div className="wewe"><Popup className='pop11' trigger={<Button variant="success" className='btnss' >Assign</Button>} position="bottom center left" >
                    <div className='po22'><form form method="POST">
                        <Form.Group as={Col} controlId="formGridState">
                            ...
                            <div className="iii3"> <Button variant="danger" href="/daily" >Close</Button>
                                {/* <Navigate to="/occasional" state={{ todos: []}} replace={true} /> */}
                            </div>
                        </Form.Group>
                    </form>
