...
export class CrudPanel3 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            mode: '',
    ...
    handle() {
        ...
        //     console.log(Response);
        // }))
        axios.post('https://sheet.best/api/sheets/6a1f2846-45f7-4d3d-b819-9e4806809dc8', this.state.record).then((Response => {
            console.log(Response);
        }))
    ...
    render() {
        return (
            <>
                ...
                <div className="wewe"><Popup className='pop11' trigger={<Button variant="success" className='btnss' >Assign</Button>} position="bottom center left" >
                    <div className='po22'><form form method="POST">
                        <Form.Group as={Col} controlId="formGridState">
                            ...
                            <div className="iii3"> <Button variant="danger" href="/monthly" >Close</Button>
                                {/* <Navigate to="/occasional" state={{ todos: []}} replace={true} /> */}
                            </div>
                        </Form.Group>
                    </form>
