...
import { data } from "C:/hackathon/zerohunger/nostarve/src/pages/data.js";
import { useState } from "react";
import AOS from 'aos';
import 'aos/dist/aos.css'
import 'C:/hackathon/zerohunger/nostarve/src/pages/hubs.css'
import { useNavigate } from 'react-router-dom';

import Navbarrecords from "./nabarrecords.js";
function Hubsadmin(props) {
    ...
    return (
        <div className="vvvv1">
            <div className="yyy1"><Navbarrecords /></div>
            <div className="liss">
